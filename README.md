...
方式二: 直接安装二进制文件
```bash
wget --no-check-certificate  https://ghproxy.com/https://github.com/mstxq17/MoreFind/releases/download/v1.0.9/MoreFind_1.0.9_`uname -s`_`uname -m`.tar.gz
tar -xzvf MoreFind_1.0.9_`uname -s`_`uname -m`.tar.gz
